...
for index in 0..<input.count {
    for n in index..<input.count {
        if input[n] + input[index] == 2020 {
            print("Part One:")
            print("\(input[n]) + \(input[index]) = \(input[n] + input[index])\n\(input[n]) * \(input[index]) = \(input[n]*input[index])")
        }
    }
}
...
for index in 0..<input.count {
    for n in index..<input.count {
        for m in n..<input.count {
            if input[n] + input[m] + input[index] == 2020 {
                print("\nPart Two:")
                print("\(input[n]) + \(input[index]) + \(input[m]) = \(input[n] + input[index] + input[m])\n\(input[n]) * \(input[index]) * \(input[m]) = \(input[n]*input[index]*input[m])")
            }
        }
    }
}
